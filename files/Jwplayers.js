...
window.jwplayer = function(t) {
                ...
                o = function(e) {
                    if (t.dragged) T(t, i.s, e);
                        ...
                        var r = E(e),
                            ...
                            a = o - t.startX,
                            c = u - t.startY;
                        a * a + c * c > 36 && (T(t, i.u, e), t.dragged = !0, T(t, i.s, e))
                    }
                    var s;
                ...
                if (Object(a.o)(e, "jw-tab-focus"), ! function(t) {
                    ...
                    if (!t.directSelect || c === e) {
                        var l = E(i),
                            f = l.pageX,
                            d = l.pageY;
                        if (t.dragged = !1, t.startX = f, t.startY = d, P(t, "window"), "pointerdown" === s && i.isPrimary) {
                            if (!n) {
                                var p = i.pointerId;
                                t.pointerId = p, e.setPointerCapture(p)
                            }
                            C(t, "window", "pointermove", o, r), C(t, "window", "pointercancel", u), C(t, "window", "pointerup", u)
                        } else "mousedown" === s ? (C(t, "window", "mousemove", o, r), C(t, "window", "mouseup", u)) : "touchstart" === s && (C(t, "window", "touchmove", o, r), C(t, "window", "touchcancel", u), C(t, "window", "touchend", u))
                    }
                }
    ...
    var O = {
        ...
        enter: function(t) {
            C(t, i.v, "keydown", (function(e) {
                "Enter" !== e.key && 13 !== e.keyCode || (e.stopPropagation(), S(t, i.v, e))
            }))
        },
        keydown: function(t) {
    ...
    e.b = function(t, e) {
        ...
        var k, C, P = parseFloat(v.bandwidthEstimate),
